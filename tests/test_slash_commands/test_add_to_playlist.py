...
# from src.slash_commands.add_to_playlist import (
...
#         self.ctx.send.called_once_with(URL_ERROR_MESSAGE, ephemeral=True)
...
#         # Mocks
#         self.ctx.send.called_once_with(NAME_ERROR_MESSAGE, ephemeral=True)
...
#         await add_to_playlist(ctx=self.ctx, url=self.url)
#         # Mocks
#         self.ctx.send.called_once_with(ARTIST_ERROR_MESSAGE, ephemeral=True)
#         self.mock_get_song_metadata_from_youtube.assert_called_once()
#         self.mock_get_song_metadata_from_spotify.assert_called_once()
#         self.mock_add_song.assert_not_called()
#         self.mock_retrieve_user.assert_not_called()
...
#         await add_to_playlist(ctx=self.ctx, url=self.url)
#         # Mocks
#         self.ctx.send.called_once_with(NAME_AND_ARTIST_ERROR_MESSAGE, ephemeral=True)
#         self.mock_get_song_metadata_from_youtube.assert_called_once()
#         self.mock_get_song_metadata_from_spotify.assert_called_once()
#         self.mock_add_song.assert_not_called()
#         self.mock_retrieve_user.assert_not_called()
...
#         )
#         # Mocks
#         self.ctx.send.called_once_with(SONG_EXISTS_ERROR_MESSAGE, ephemeral=True)
#         self.mock_get_song_metadata_from_youtube.assert_called_once()
#         self.mock_get_song_metadata_from_spotify.assert_called_once()
...
#         )
#         # Mocks
#         self.ctx.send.called_once_with(USER_RETRIEVAL_ERROR_MESSAGE, ephemeral=True)
#         self.mock_get_song_metadata_from_youtube.assert_called_once()
#         self.mock_get_song_metadata_from_spotify.assert_called_once()
#         self.mock_add_song.assert_called_once()
...
#         )
#         # Mocks
#         self.ctx.send.called_once_with(USER_ADD_ERROR_MESSAGE, ephemeral=True)
#         self.mock_get_song_metadata_from_youtube.assert_called_once()
#         self.mock_get_song_metadata_from_spotify.assert_called_once()
#         self.mock_add_song.assert_called_once()
#         self.mock_retrieve_user.assert_called_once()
...
#         )
#         # Mocks
#         self.ctx.send.called_once_with(SONG_ADD_ERROR_MESSAGE, ephemeral=True)
#         self.mock_get_song_metadata_from_youtube.assert_called_once()
#         self.mock_get_song_metadata_from_spotify.assert_called_once()
#         self.mock_add_song.assert_called_once()
#         self.mock_retrieve_user.assert_called_once()
...
#         )
#         # Mocks
#         self.ctx.send.called_once_with(
